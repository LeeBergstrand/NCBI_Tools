                                           ...
                                           const KPath * path)
{
    ...
    *f = NULL;
    ...
    if (rc == 0)
    {
        ...
        rc = KDirectoryResolvePath (cwd, true, rbuff, sizeof rbuff, pbuff);
        if (rc == 0)
        {
            uint32_t type;

            type = KDirectoryPathType (cwd, rbuff);
            ...
            case kptFile:
                rc = KDirectoryOpenFileRead (cwd, f, rbuff);
                break;
    ...
    *f = NULL;
    ...
    if (rc == 0)
    {
        ...
        if (rc == 0)
        {
            ...
            case kptFile:
                rc = KDirectoryOpenFileWrite (cwd, f, update, rbuff);
                break;
                                      ...
                                      const KPath * path )
{
    ...
    if (rc == 0)
    {
        ...
        if (rc == 0)
        {
            ...
            case kptFIFO:
            case kptZombieFile:
                rc = KDirectoryRemove (cwd, force, rbuff);
                break;

...
#ifdef TOLERATE_CIRCULAR_SRAPATH_VFS_DEPENDENCY
                             ...
                             )
{
    ...
    return rc;
#else /* TOLERATE_CIRCULAR_SRAPATH_VFS_DEPENDENCY */
    return RC ( rcSRA, rcMgr, rcAccessing, rcInterface, rcUnsupported );
#endif
}

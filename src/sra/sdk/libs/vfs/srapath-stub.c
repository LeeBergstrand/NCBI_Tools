...
/*
MOD_EXPORT
rc_t CC SRAPathMakeImpl ( SRAPath **pm, const struct KDirectory *dir )
{
    return RC ( rcSRA, rcMgr, rcConstructing, rcInterface, rcUnsupported );
}
*/
...
rc_t CC RegisterSRAPathMake ( rc_t ( CC * maker ) ( SRAPath **pm, struct KDirectory const *dir ) )
{

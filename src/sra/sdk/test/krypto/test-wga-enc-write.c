 ...
 */
#define TEST      "wga-enc/test.txt.gz.test_enc"
#define ENCRYPT   "wga-enc/test.txt.gz.ncbi_enc"
#define UNENCRYPT "wga-enc/test.txt.gz"
...
rc_t CC UsageSummary (const char * progname)
{
    return KOutMsg (
        ...
        "\n"
        "Summary:\n"
        "  writing 'wga' ncbi encryption\n",
        progname);
}


const char UsageDefaultName[] = "test-wga-enc-write";

...
arch-dbg:
	...
	@ bash cp.sh $(MODDIR) $(TRACE_SOFTWARE)/$(OS)/debug/$(ARCH)/mod "! -type d -print"
	@ bash cp.sh $(WMODDIR) $(TRACE_SOFTWARE)/$(OS)/debug/$(ARCH)/wmod "! -type d -print"
...
arch-rel:
	...
	@ bash cp.sh $(MODDIR) $(TRACE_SOFTWARE)/$(OS)/release/$(ARCH)/mod "! -type d -print"
	@ bash cp.sh $(WMODDIR) $(TRACE_SOFTWARE)/$(OS)/release/$(ARCH)/wmod "! -type d -print"

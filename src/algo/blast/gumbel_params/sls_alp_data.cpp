/* $Id: sls_alp_data.cpp 380423 2012-11-13 16:55:32Z boratyng $
* ===========================================================================
*
                   ...
                   CRef<CGumbelParamsRandDiagnostics>& rand_params_)
{
        ...
        try
        {
                ...
                Int4 i,j;
                d_number_of_AA_smatr=options_->GetNumResidues();
                ...
                for(i=0;i<d_number_of_AA_smatr;i++)
                {
                        ...
                        {
                                d_smatr[i][j]=(options_->GetScoreMatrix())[i][j];
                        };
                };
                ...
                d_open=options_->GetGapOpening()+options_->GetGapExtension();

                d_epen=options_->GetGapExtension();

                d_max_time=options_->GetMaxCalcTime();

                d_max_mem=options_->GetMaxCalcMemory();

                d_eps_lambda=options_->GetLambdaAccuracy();

                d_eps_K=options_->GetKAccuracy();

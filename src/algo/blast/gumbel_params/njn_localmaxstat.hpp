#ifndef ALGO_BLAST_GUMBEL_PARAMS__INCLUDED_NJN_LOCALMAXSTAT
#define ALGO_BLAST_GUMBEL_PARAMS__INCLUDED_NJN_LOCALMAXSTAT

/* $Id: njn_localmaxstat.hpp 183505 2010-02-18 16:10:58Z boratyng $
* ===========================================================================
*
...
BEGIN_SCOPE(Njn)
    ...
    //    with the correspondence to probabilities maintained, placed in ascending order.
      ...
      const Int4 *score_ = 0, // scores in increasing order
      ...
      inline Int4 getDelta () const {return d_delta;} // span
      ...
      Int4 *d_score_p; // scores in increasing order
...
#endif //! ALGO_BLAST_GUMBEL_PARAMS__INCLUDED_NJN_LOCALMAXSTAT

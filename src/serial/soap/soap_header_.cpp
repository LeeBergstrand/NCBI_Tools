/* $Id: soap_header_.cpp 341797 2011-10-24 13:50:24Z gouriano $
 * ===========================================================================
 *
...
void CSoapHeader_Base::ResetAnyContent(void)
{
    m_AnyContent.clear();
    m_set_State[0] &= ~0x3;
}

void CSoapHeader_Base::Reset(void)
{
    ResetAnyContent();
}
...
// constructor
CSoapHeader_Base::CSoapHeader_Base(void)
{
